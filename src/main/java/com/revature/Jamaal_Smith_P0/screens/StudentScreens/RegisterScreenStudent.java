...
public class RegisterScreenStudent extends Screen {
    private final Logger logger = LogManager.getLogger(RegisterScreenStudent.class);
    private final UserService userService;
    public Bson username;

    public RegisterScreenStudent(BufferedReader consoleReader, ScreenRouter router, UserService userService) {
        super("RegisterScreenStudent", "/registerStudent", consoleReader, router);
