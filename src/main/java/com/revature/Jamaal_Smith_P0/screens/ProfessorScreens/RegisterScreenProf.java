...
public class RegisterScreenProf extends Screen {
    private final Logger logger = LogManager.getLogger(RegisterScreenProf.class);
    private final UserService userService;
    public Bson username;

    public RegisterScreenProf(BufferedReader consoleReader, ScreenRouter router, UserService userService) {
        super("RegisterScreenProf", "/registerProf", consoleReader, router);
