...
public class LoginScreenProf extends Screen {

    private final UserService userService;
    private final Logger logger = LogManager.getLogger(RegisterScreen.class);

    public LoginScreenProf(BufferedReader consoleReader, ScreenRouter router, UserService userService) {
        super("LoginScreenStudentProf", "/loginProf", consoleReader, router);
